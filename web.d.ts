...
declare namespace $ {
     ...
     */
    const $mol_theme: Record<"image" | "line" | "text" | "field" | "card" | "focus" | "back" | "hover" | "current" | "special" | "control" | "shade" | "spirit" | "hue" | "hue_spread", $mol_style_func<"var", unknown>>;
}
...
declare namespace $.$$ {
    class $hyoo_shelter_shelter_manage extends $.$hyoo_shelter_shelter_manage {
        ...
        can_add(): boolean;
        card_shelters(): any;
        animals_page_tools(): ($.$mol_search | $mol_button_major | $.$mol_link)[];
        download_link(): any;
        download_name(): string;
        summary_1w(): any;
        summary_1m(): any;
